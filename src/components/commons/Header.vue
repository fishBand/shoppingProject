      ...
      <template v-if="user!=null">
        <el-menu :default-active="'2'" class="el-menu-demo" mode="horizontal">
          <el-submenu index="2" style="float: right">
			...
			<el-menu-item index="2-6">
			  <li>
				<a tabindex="-1" @click="goto('/account/invoice','Invoice')">
				  <i class="fa fa-jpy"></i>常用发票信息
				</a>
			  </li>
			</el-menu-item>
			<el-menu-item index="2-7">
			  <li>
				<a tabindex="-1" @click="goto('/account/footPrint','footPrint')">
				  <i class="fa fa-jpy"></i>我的足迹
				</a>
			  </li>
			</el-menu-item>
                ...
                <div id="divCart" class="quick-cart-wrapper" v-if="cartList">
                  <template>
                    <a v-for="product in cartList.productList" @click="viewCartProduct(product.id)">
                      ...
                      <small>{{(product.shopPrice/100*product.quantity).toFixed(1)}}</small>
                    </a>
                  </template>
                </div>
                <!-- quick cart footer -->
